...
<?php if ($_SESSION['ubp'] == "") {
	...
	echo $uprofile;
					...
					<table class="table">
						...
						if (WhatsAppAPI::isEnabled($API)) {
							?>
							<tr>
								<td class="align-middle"><i class="fa fa-whatsapp"></i> WhatsApp</td>
								<td>
									<input class="form-control" type="text" name="wa_phone" placeholder="628123456789"
										autocomplete="off">
									<small style="opacity:0.7;">Isi untuk mengirim voucher via WhatsApp</small>
								</td>
							</tr>
						<?php } ?>
						<tr>
