...
if (!isset($_SESSION["mikhmon"])) {
  ...
  if ($hotspot == "dashboard" || substr(end(explode("/", $url)), 0, 8) == "?session") {
    ...
    $settmenu = "menu-open";
  } elseif ($hotspot == "access-points" || $hotspot == "add-access-point" || $hotspot == "edit-access-point") {
    $saccesspoints = "active";
    $mpage = "Data Access Point";
  ...
  <div id="sidenav" class="sidenav">
    <?php if (($id == "settings" && $session == "new") || $id == "settings" && $router == "new") {
      ...
      ?>
        ...
        <?= $_dashboard ?></a>
        <a href="./admin.php?id=settings&session=<?= $session; ?>" class="menu <?= $ssettings; ?>" title="Mikhmon Settings"><i
  ...
  <div id="sidenav" class="sidenav">
    ...
    <div class="dropdown-container <?= $umenu . $upmenu . $hamenu . $hmenu . $ibmenu . $cmenu; ?>">
      ...
      <div class="dropdown-container <?= $umenu; ?>">
        ...
        <a href="./?hotspot-user=generate&session=<?= $session; ?>" class="<?= $sgenuser; ?>"> &nbsp;&nbsp;&nbsp;<i
            class="fa fa-user-plus"></i> <?= $_generate ?> </a>
      </div>
      <!--profile-->
    ...
    <!--dhcp leases-->
    <a href="./?hotspot=dhcp-leases&session=<?= $session; ?>" class="menu <?= $slease; ?>"><i class=" fa fa-sitemap"></i>
      <?= $_dhcp_leases ?></a>
    <!--traffic monitor-->
    <a href="./?interface=traffic-monitor&session=<?= $session; ?>" class="menu <?= $strafficmonitor; ?>"><i
        class=" fa fa-area-chart"></i> <?= $_traffic_monitor ?></a>
    <!--access points-->
    <a href="./?hotspot=access-points&session=<?= $session; ?>" class="menu <?= $saccesspoints; ?>"><i class="fa fa-wifi"></i> Data Access Point</a>
    <!--whatsapp gateway-->
    <a href="./?hotspot=whatsapp-gateway&session=<?= $session; ?>" class="menu <?= $swhatsapp; ?>"><i class="fa fa-whatsapp"></i> WhatsApp Gateway</a>
    <!--report-->
    <a href="./?report=selling&idbl=<?= strtolower(date("M")) . date("Y"); ?>&session=<?= $session; ?>"
    ...
    <div class="dropdown-container <?= $settmenu; ?>">
      ...
      <a href="./?hotspot=uplogo&session=<?= $session; ?>" class="menu <?= $uplogo; ?>"> <i class="fa fa-upload "></i>
        <?= $_upload_logo ?> </a>
      <a href="./?hotspot=template-editor&template=default&session=<?= $session; ?>" class="menu <?= $teditor; ?>"> <i
          class="fa fa-edit "></i> <?= $_template_editor ?> </a>
    </div>
    <!--about-->
